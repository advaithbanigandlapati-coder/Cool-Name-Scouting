...
function ScoutTeamPicker({ selectedTeam, setSelectedTeam, manualNum, setManualNum,
  manualName, setManualName, notListed, setNotListed, teamList }) {
  ...
  return (
    <div style={{flex:1,overflowY:'auto'}}>
      <div style={{maxWidth:520,margin:'0 auto',padding:'20px 16px 48px'}}>
        ...
        {/* Team picker */}
        <ScoutTeamPicker selectedTeam={selectedTeam} setSelectedTeam={setSelectedTeam}
          manualNum={manualNum} setManualNum={setManualNum}
          manualName={manualName} setManualName={setManualName}
          notListed={notListed} setNotListed={setNotListed}
          teamList={teamList}/>
