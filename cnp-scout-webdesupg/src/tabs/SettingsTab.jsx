    ...
    <div style={{ flex:1, overflowY:'auto', padding:24 }}>
      <div style={{ maxWidth:800, margin:'0 auto', display:'flex', flexDirection:'column', gap:20 }}>
        ...
        <div className="card">
          ...
          <p style={{ fontSize:12, color:'#a3a3a3', marginBottom:14 }}>
            Required for AI Analyze and Chat. Get yours at <b style={{color:'#f97316'}}>console.anthropic.com</b> → API Keys.
          </p>
          <div>
            <label>API Key</label>
            <input
            ...
            />
            {local.claudeApiKey && (
              <div style={{fontSize:11,color:'#22c55e',marginTop:6}}>✓ Key saved</div>
            )}
          </div>
        </div>
